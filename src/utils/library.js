...
import {
  GotoXandYComponent,
  Move10StepsComponent,
  SayHelloForSecondsComponent,
  ShowHideComponent,
  Turn15DegreeComponentUndo,
  widgetNames,
} from "./constants";
...
export const widgetLibrary = {
  ...
  [widgetNames.turn15DegreeComponentRedo]: {
    ...
    component: (
      <Turn15DegreeComponentUndo type={widgetNames.turn15DegreeComponentRedo} />
    ),
  },
  ...
  [widgetNames.sayHelloForSeconds]: {
    ...
    component: (
      <SayHelloForSecondsComponent type={widgetNames.sayHelloForSeconds} />
    ),
  },
  [widgetNames.sayHmm]: {
  ...
  [widgetNames.sayHmmForSeconds]: {
    name: widgetNames.sayHmm,
    component: (
      <SayHelloForSecondsComponent type={widgetNames.sayHmmForSeconds} />
    ),
  },
  [widgetNames.show]: {
